  ...
  const CHANGELOG: { version: string; notes: string[] }[] = [
    {
      ...
      notes: [
        ...
        'Groups with mention required: a member message that does not mention Claude is now kept in the local log (text only) and shown by catch_up as "not addressed to Claude", so you can ask for a message to that group with the room in view. It is never routed, never notified and never counted as unreplied.',
      ],
    },
    {
      version: "0.21.2",
